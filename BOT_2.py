...
def proverka_vremeny():
    ...
    if len(vremena) > 1:
        for i in range(len(vremena) - 1):
            if abs(vremena[i + 1] - vremena[i]) > 3:
                return True
    return False
...
try:
    for event in longpoll.listen():
        if event.type == VkBotEventType.MESSAGE_NEW:
            ...
            if regim == 3:
                if event.message.text.lower() == 'хорошо':
                    sender(
                        "https://market.yandex.ru/search?text=%D1%81%D0%BB%D0%BE%D0%BD&cvredirect=2&cpa=0&onstock=0&local-offers-first=0",
            ...
            if n == 1004 or n == 10000:
                ...
                regim = 2
                sender('Выберите режим сложности', id, keybord_vibor_saymon)
                keyboard_saymon = copy.deepcopy(keyboard1_saymon)
                ...
                if regim == 4:
                    ...
                    if n == 101 or n == 102 or n == 103 or n == 10:
                        sp_saymon = []
                        sp1_saymon = []
                        ...
                        if game_saymon:
                            if n == sp1_saymon[0]:
                                ...
                                if proverka_vremeny():
                                    ...
                                    sender('Превышен лимит времени', id, keyboard_saymon)
